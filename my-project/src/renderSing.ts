export function renderSing(container: HTMLElement) {
 container.innerHTML = `
    ...
    <div class="flex justify-center items-center w-full md:w-1/2">
      <div class="bg-gray-100 rounded-2xl shadow-lg p-8 mt-[80px] md:p-12 min-h-[600px] w-full max-w-[800px] ml-[20px] flex flex-col justify-center h-full">
        ...
        <h2 class="text-4xl font-semibold text-gray-300 mb-[100px] text-center">
            <span class="text-[#3F99B4]">Signup/</span>
            <span class="text-gray-300 transition-transform duration-300 hover:scale-105 inline-block">
                Login
            </span>
        </h2>

        <!-- Mr Bean Image (behind) -->
    <div class="flex justify-center mb-0 relative z-0">
    ...
    <input type="password" placeholder="Password" 
       class="w-full bg-gray-100 mb-2 px-4 py-3 border border-gray-300 rounded-3xl" />
        ...
        <p class="text-sm text-gray-600 mt-6 text-center">
          ...
          <button onclick="showRegister()" class="text-[#055D65] font-semibold underline">Signup</button>
        </p>
      </div>
    </div>
